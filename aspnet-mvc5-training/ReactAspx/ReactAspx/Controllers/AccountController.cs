...
namespace ReactAspx.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(Customer user)
        {
            ...
            // If login failed, see the login page again.
            return View();
        }
        ...
        public async Task<ActionResult> Register(Customer user)
        {
            ...
            using (var db = new AppDbContext())
            {
                // Initialise an instance of Customer to check if the Customer exits or not with the email address.
                Customer customer = db.Customers.Where(u => u.Email == user.Email).FirstOrDefault();

                // Check if the Customer exits or not.
                if (customer != null)
                {
                    ViewBag.ErrMessage = "User Exits!";
                }
                else
                {
